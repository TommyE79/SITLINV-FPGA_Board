...
HD_PWD='G:/BaiduNetdiskDownload/K7325_676_hdmi_inout/RJ45_B_rgmii_1G/golden_rgmii_1gb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log golden_rgmii_1gb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source golden_rgmii_1gb.tcl
