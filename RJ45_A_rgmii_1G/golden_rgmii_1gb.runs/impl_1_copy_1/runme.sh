...
HD_PWD='G:/BaiduNetdiskDownload/K7325_676_hdmi_inout/RJ45_A_rgmii_1G/golden_rgmii_1gb.runs/impl_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log golden_rgmii_1gb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source golden_rgmii_1gb.tcl -notrace
